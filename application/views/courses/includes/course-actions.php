<?php if (user_can('see', 'course', $course->id)) : ?>
	...
	<?php if (user_can('add', 'course', $course->id)) : ?>
...
<?php if (user_can('delete', 'course', $course->id)) : ?>
	<a class="btn btn-danger confirm" title="Supprimer ce cours" href="#" class="confirm btn btn-danger btn-sm" data-url="<?php echo base_url('courses/delete/' . $course->id) ?>" data-header="Suppression d'un cours" data-body="<p>Attention!</p><p>Vous êtes sur le point de supprimer un cours.</p><p>Continuer?</p> ">
