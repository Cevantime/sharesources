...
<html lang="en">
	...
	<head>
		...
		<link href="<?php echo base_url('assets/vendor/css/jquery-ui.min.css'); ?>" rel="stylesheet" type="text/css">
		<link href="<?php echo base_url('assets/vendor/css/custom-theme/jquery-ui-1.10.0.custom.css'); ?>" rel="stylesheet" type="text/css">
		<link href="<?php echo base_url('assets/vendor/css/custom-theme/jquery.ui.1.10.0.ie.css'); ?>" rel="stylesheet" type="text/css">
	...
	<body>
		...
		<!-- jQuery -->
		<script src="<?php echo base_url('assets/vendor/js/jquery/jquery.min.js'); ?>"></script>
		<script src="<?php echo base_url('assets/vendor/js/jquery-ui.min.js'); ?>"></script>
		<!-- Bootstrap Core JavaScript -->
		<script src="<?php echo base_url('assets/vendor/js/bootstrap/bootstrap.min.js'); ?>"></script>

		<!-- Metis Menu Plugin JavaScript -->
		<script src="<?php echo base_url('assets/vendor/js/metisMenu/metisMenu.min.js'); ?>"></script>
