...
putenv('APPLICATION_ENV=recette');
...
passthru("java -jar $liquibaseJarFile --classpath=$mysqlConnectorPath --changeLogFile=$changelogFile --username=$username --password=$password --logLevel=info --url=jdbc:mysql://$dbhost/$dbname update 2>&1", $output);
